...
Original file is located at
    https://colab.research.google.com/drive/1TxYpKOZ2yCHIdLrYmr_ZbwIYh1oxkBRy
"""

# from google.colab import drive
# drive.mount('/content/drive')

# !pip install -r drive/MyDrive/EfficientAI/requirements.txt
...
def compute_fid_metrics(ref_batch_path: str, sample_batch_path: str):
    """
    Computes FID, sFID, Inception Score, Precision, and Recall
    between a reference batch and a sample batch using OpenAI's FID evaluator.
    ...
    Returns:
        dict: Dictionary with keys: 'fid', 'sfid', 'inception_score', 'precision', 'recall'
    """
    import tensorflow.compat.v1 as tf
    ...
    with tf.Session(config=config) as sess:
        ...
        print("Reading reference batch statistics...")
        ...
        print("Reading sample batch statistics...")
...
print(compute_fid_metrics('VIRTUAL_imagenet256_labeled.npz', 'GenImagesBlockIncreasing.npz'))

# compute_fid_metrics('/content/drive/MyDrive/EfficientAI/VIRTUAL_imagenet256_labeled.npz', '/content/drive/MyDrive/NYU/GenImagesPruned.npz')

#pruning amount with respect to time. (Prune more in the beginning and then as the fine grained features are being generated prune less)